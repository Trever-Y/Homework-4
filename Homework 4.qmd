...
my_list1 <- list("1. What is the purpose of the lapply() function? What is the equivalent purrr function?",
...
resp[c(1,5)] <- NA_real_
my_wrapper(resp, pred, metrics = "MAE")
my_wrapper(resp, pred, metrics = "RMSE", na.rm = TRUE) #tested with specifying behavior like in #4
my_wrapper(resp, pred, metrics = c("MAE", "RMSE"))
