...
```{r}
URL_ids <- "https://newsapi.org/v2/everything?q=war&from=2025-06-25&sortBy=popularity&apiKey=93563897e7a24afaaac43bd50c70d0af"
id_info <- GET(URL_ids)
...
```{r}
URL_ids <- "https://newsapi.org/v2/everything?q=gamestop&from=2025-05-27&sortBy=popularity&apiKey=93563897e7a24afaaac43bd50c70d0af"
id_info <- GET(URL_ids)
parsed_data <- fromJSON(rawToChar(id_info$content))
as_tibble(parsed_data)
str(id_info, max.level = 1)
id_info$headers
```
93563897e7a24afaaac43bd50c70d0af